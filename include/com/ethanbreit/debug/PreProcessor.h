...
#define ge_DEBUG_TIMER_END(m) __end = std::chrono::system_clock::now(); elapsed_seconds = __end - __start; ConsoleIO::print("process name: "+std::string(m)+", elapsed time: " + std::to_string(elapsed_seconds.count()) + "s\n", ge::MessageType::Debug);
