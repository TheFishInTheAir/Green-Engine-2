...
namespace ge
{
    struct DefaultComponentBatch : public ComponentBatch
    {
        DefaultComponentBatch();
        
        std::vector<Component*> components;
        
        void cycle();
        
        ge_START_CYCLE_HANDLER(DefaultComponentBatch)
            ge_GENERATE_TRAMPOLINE(cycle, UPDATE)
